...
export function ContactForm() {
  const [state, formAction, pending] = useActionState(submitContactEn, initialState);
    ...
    <form action={formAction} className="space-y-5" noValidate>
      ...
      <div>
        <label htmlFor="company" className="text-sm font-medium text-[var(--color-text)]">
          Company <span className="text-[var(--color-text-faint)]">(optional)</span>
        </label>
        <input
          id="company"
          name="company"
      ...
      <div>
        ...
        <textarea
          ...
          placeholder="Briefly describe your project and goal."
        />
      ...
      {/* Honeypot — invisible, no user fills it in */}
