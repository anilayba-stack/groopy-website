...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "Calculate your website's SEO score for free. Analyze title tags, meta description, mobile-friendliness, structured data, and AI search access in seconds, based on real, verifiable criteria.",
